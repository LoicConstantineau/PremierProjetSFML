...
#
get_filename_component(filename "/Users/loicconstantineau/Desktop/VSCode/C++/PremierProjetSFML/build/_deps/libssh2-tmp/704299e997bf518375dc9222670c57b800ac59e6.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/loicconstantineau/Desktop/VSCode/C++/PremierProjetSFML/build/_deps/libssh2-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libssh2${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libssh2${i}")
