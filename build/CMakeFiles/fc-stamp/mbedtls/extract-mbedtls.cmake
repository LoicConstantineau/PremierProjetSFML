...
#
get_filename_component(filename "/Users/loicconstantineau/Desktop/VSCode/C++/PremierProjetSFML/build/_deps/mbedtls-tmp/mbedtls-3.6.5.tar.bz2" ABSOLUTE)
get_filename_component(directory "/Users/loicconstantineau/Desktop/VSCode/C++/PremierProjetSFML/build/_deps/mbedtls-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-mbedtls${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-mbedtls${i}")
